export default {
    home: {//首页文案
        ...
        h2: 'By programming tokens, we have implemented and deployed a set of smart contracts for real-time payment, trading, token issurance etc on Ethereum',
        startBtn: 'Start',
        introduce: {
            ...
            fixedVal: 'The stream flows to the recipient at a rate per second after the start time until it equals' +
                'the max amount paid. No need to set stop time, could increase the max payment amount to extend stream.',
